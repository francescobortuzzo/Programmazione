...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 20211109_4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
...
(define btr-carry                ; val: carattere +/./-
 (lambda (digit-1 digit-2 carry) ; digit-1, digit-2, carry: caratteri +/./-
  (cond
   (
    (or
...
(define btr-carry-sum        ; btr-carry-sum: stringa
 (lambda (int-1 int-2 carry) ; int-1, int-2, carry: stringa, stringa, carattere +/./-
  (normalized-btr
...
(define btr-sum        ; val: stringa
 (lambda (int-1 int-2) ; int-1, int-2: stringhe
